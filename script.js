...
function checkWin(){
	if(board.b0.value == board.b1.value && board.b1.value == board.b2.value && board.b0.value != ""){
		...
		announceWin(board.b0.value);
	}else if(board.b1.value == board.b4.value && board.b4.value == board.b7.value && board.b7.value != ""){
...
function announceWin(winner){
	currentPlayer = 0;
	document.querySelector('#popup').innerHTML = "<img src='images/xbutton.png' alt='x button' id='x'><h2>" + winner + " Wins!</h>";
